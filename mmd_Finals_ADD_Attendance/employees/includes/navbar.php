...
<nav class="navbar navbar-expand-lg navbar-dark p-4" style="background-color: #008080;">
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a id="leaveTitle" class="nav-link" href="leaves.php">
          Leaves<?php if (numberOfUnreadEmployee($pdo, $_SESSION['user_id']) > 0) { ?>(<?= numberOfUnreadEmployee($pdo, $_SESSION['user_id']) ?>)<?php } ?>
        </a>
      </li>
      <li class="nav-item">
